...
import FREETOPLAYCard from './cards/FREETOPLAYCard'
function FREETOPLAY() {
  return (
         
    <div className='flex justify-center items-  px-3 lg:px-5 md:px-4 w-full bg-black'>
...
<div className="bg-black w-full custom-container   flex justify-center items-center flex-col">
    <div className="w-full  flex justify-center items-center	">
            ...
            <div className="pt-16 w-100  flex justify-between items-center flex-wrap	">
                <div>
                <h3 className='text-xl md:text-2xl  lg:text-[32px] 	 font-semibold 	 uppercase text-white  mb-0'>FREE-TO-PLAY</h3>
                 </div>
