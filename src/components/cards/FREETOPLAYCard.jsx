...
function FREETOPLAYCard({ key, bgImage, iconOne, titleOne, titleTwo }) {
  return (
    <div className="w-full max-w-[424px] h-[346px] relative	gradient-border " >
